...
public class TaleSelectionActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            Intent intent = new Intent(TaleSelectionActivity4.this, Tale4PartSelectionActivity.class);
    ...
    private void loadTalesFromJson(int groupId) {
        try {
            ...
            InputStream is = getAssets().open("tales_4.json");
            ...
            for(int i=0;i<fullJson.length();i++){
                JSONObject tale = fullJson.getJSONObject(i);
...
//                    Toast.makeText(this, "+1 prikazka", Toast.LENGTH_SHORT).show();
                }
            }
